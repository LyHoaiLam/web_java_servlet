	...
	public ArrayList<SanPham> selectAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				SanPham sp = new SanPham(masanpham, tensanpham, tacGia/*Cần TacGia chứ không cần matacgia nhưng cần matacgia để lấy ra đc TacGia */,
				namxuatban, gianhap, giagoc, giaban, soluong,
