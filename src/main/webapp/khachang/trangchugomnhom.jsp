			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<form class="d-flex" role="search">
					...
					<%
						...
						if(khachHang==null){
					%>
						<a class="btn btn-primary" style="white-space: nowrap;" href="khach-hang?hanhDong=dang-nhap">
							Đăng nhập
						</a>
					<%} else { %>
						...
						<ul class="navbar-vav me-auto mb-2 mb-lg-0">
							<li class="nav-item dropdown">
								<button type="button" class="btn btn-danger dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="false">
								Tài khoản <b><%=khachHang.getTenDangNhap() %></b>
								</button>
								<ul class="dropdown-menu">
									<li>
									...
									<li>
										<a class="dropdown-item" href="khach-hang?hanhDong=thay-doi-thong-tin">Thay đổi thông tin</a>
									</li>
									<li>
										<a class="dropdown-item" href="khach-hang?hanhDong=doi-mat-khau">Thay đổi mật khẩu</a>
									</li>
									<li>
										<div class="dropdown-divider"></div>
									</li>
									<li>
										<a class="dropdown-item" href="khach-hang?hanhDong=dang-xuat">Đăng xuất</a>
                                        <!-- hanhDong là parameter, dang-xuat là gia tri parameter cua hanhDong -->
									</li>
