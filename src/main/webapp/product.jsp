...
<%
    ...
    /* Tuong đương
    if(e_maSanPham -- null || e_maSanPham.equal("null")){
        e_maSanPham = "";
    }*/
    ...
    /*Nếu sản phẩm equal = null thì cho về chuỗi rỗng ngược lại thì tên sản phẩm*/
	value_tenSanPham=(value_tenSanPham.equals("null"))?"":value_tenSanPham;
	value_giaBan= (value_giaBan.equals("null"))?"":value_giaBan;
    /*Nếu giaBan equal = null thì cho về chuỗi rỗng ngược lại thì tên giaBan*/
