...
<html>
    <head>
        ...
        %>
        <!-- getScheme() là Http or Htpps -->
        <!-- getServerName() thường là localhost or tên domainname or post -->
        <!-- getContextPath thường là tên project của bạn -->

        <link rel="stylesheet" href="<%=url %>/css/signin.css">
        <!-- Đi sang page nào đi nữa thì đường dẫn luôn là chính xác -->
        <!-- <link rel="stylesheet" href="css/signin.css"> Tương đương như trên -->
    </head>
   
    <body>
        
      <main class="form-signin w-100 m-auto">
        <form class="text-center" action="dang-nhapweb" method="POST">
