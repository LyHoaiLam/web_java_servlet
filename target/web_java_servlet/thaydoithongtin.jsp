...
<body>
	...
	<%
		...
		KhachHang khachHang = null;// Khi nao2 KhachHang Đăng nhập thì lấy thông tin KhachHang. Còn chưa đăng nhập thì báo yêu cầu đăng nhập
		if (obj!=null)
	...
	<div class="container">
		<!-- Lấy thông tin của KhachHang đã đăng nhập lên -->
			<%
